...
const defaultPermissions = {
  ...
  bcba: ["patients.view", "patients.edit", "sessions.view", "sessions.edit", "sessions.review", "behaviors.view", "behaviors.edit", "behaviors.review", "plans.view", "plans.edit", "plans.review", "incidents.view", "incidents.edit", "incidents.review", "reports.view", "reports.edit", "reports.review", "isps.view", "isps.edit", "isps.review", "audit.view"],
  supervisor: ["patients.view", "patients.edit", "sessions.view", "sessions.edit", "sessions.review", "behaviors.view", "behaviors.edit", "behaviors.review", "plans.view", "plans.edit", "incidents.view", "incidents.edit", "incidents.review", "reports.view", "reports.edit", "reports.review", "isps.view", "isps.edit", "isps.review"],
  therapist: ["patients.view", "sessions.view", "sessions.edit", "behaviors.view", "behaviors.edit", "incidents.view", "incidents.edit", "reports.view", "reports.edit", "isps.view"],
  rbt: ["patients.view", "sessions.view", "sessions.edit", "behaviors.view", "behaviors.edit", "incidents.view", "incidents.edit", "isps.view"],
  billing_auditor: ["patients.view", "sessions.view", "reports.view", "isps.view", "audit.view"],
  read_only: ["patients.view", "sessions.view", "behaviors.view", "plans.view", "incidents.view", "reports.view", "isps.view"]
};
...
app.get("/api/analytics/dashboard", requireAuth, requireMfa, async (req, res) => {
  try {
    ...
    const staffWorkload = (await pool.query(`
      ...
      ORDER BY 4 DESC, 5 DESC, 6 DESC, 7 DESC, u.full_name ASC
      LIMIT 20`, [orgId])).rows;
...
app.get("/api/ai/workbench/bootstrap", requireAuth, requireMfa, requireAiWorkbenchAccess, async (req, res) => {
  try {
    ...
    res.json({ patients, history, agent_skill: { path: getAbaAgentSkill().path, source: getAbaAgentSkill().source } });
  } catch (e) {
